...
/* const big_box = new Entity(Shape.Rectangle(100, 50), material);
big_box.position = new Vector(500, 400);
simulation.entities.push(big_box); */

const box = new Entity(Shape.Rectangle(50, 50), material);
box.position = new Vector(500, 535);
simulation.entities.push(box);

const floor = new Entity(Shape.Rectangle(800, 20), material);
floor.kinematic = true;
floor.position = new Vector(500, 500);
simulation.entities.push(floor);
